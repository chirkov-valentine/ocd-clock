...
namespace OCDClock
{
    ...
    public class ClockControl : Control
    {
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            {
                // Fallback to Arial with Normal weight if the specified font/weight combination is unavailable
                _hourFont = new Typeface(new FontFamily("Arial"), FontStyles.Normal, FontWeights.Normal, FontStretches.Normal);
                if (!_hourFont.TryGetGlyphTypeface(out _hourFontGlyph))
